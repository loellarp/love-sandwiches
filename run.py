...
def get_stock_values (data):
    """
    Build and return a dictionary with headings and stock recommendations
    """
    headings = SHEET.worksheet("stock").row_values(1)
    new_stock_values = {headings[i]:data[i] for i in range(len(headings))}
    return new_stock_values
    
stock_values = get_stock_values(stock_data)
print("Your stock recommendations:")
print(stock_values)